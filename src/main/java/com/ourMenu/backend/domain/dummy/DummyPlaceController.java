...
public class DummyPlaceController {
    ...
    public ApiResponse<List<Place>> getAllplace(){
        ...
        places.add(new Place(1, "화산라멘 홍대점", 3, 12312.2423, 12312.2423));
        places.add(new Place(2, "화산라멘 강남점", 3, 12312.2424, 12312.2424));
        places.add(new Place(3, "화산라멘 신촌점", 3, 12312.2425, 12312.2425));
