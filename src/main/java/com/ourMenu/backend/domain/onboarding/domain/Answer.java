...
public enum Answer {
    FEELING("좋아!", S3Util.S3Path + "좋아.svg", S3Util.S3Path + "기분이 꿀꿀할때는 돼지 파티다.svg", AnswerFood.LIKE,
            "별로야..", S3Util.S3Path + "별로야.svg", S3Util.S3Path + "기분이 저기압일 땐 고기 앞으로 가라.svg", AnswerFood.DISLIKE),
    WEATHER("맑아", S3Util.S3Path + "맑아.svg", S3Util.S3Path + "날씨도 맑은데 바깥에서 피크닉 어때요_.svg", AnswerFood.SUNNY,
            "비가 오네", S3Util.S3Path + "비가와.svg", S3Util.S3Path + "비오고 쌀쌀할 때 뜨끈한 국물 어때요_.svg", AnswerFood.RAINY),
    ...
    SEASON("여름", S3Util.S3Path + "여름.svg", S3Util.S3Path + "따가운 햇살엔 이열치열! 뜨거운 음식들.svg", AnswerFood.SUMMER,
            "겨울", S3Util.S3Path + "겨울.svg", S3Util.S3Path + "따가운 햇살을 이겨내는 차가운 음식들 어때요_.svg", AnswerFood.WINTER),
    ;
